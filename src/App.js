...
export default function App() {
  ...
  function calcularIMC(){
    ...
    if(imc < 18.6) {
      ...
      setMensagem("Cuidado você está muito acima do peso! Seu IMC: " + imc.toFixed(2))
    }
  }
  ...
  return(
    <div className="app">
      ...
      <div className="input">
        ...
        <input type="text" placeholder="Altura em (cm) Ex: 190" value={altura} onChange={(e) => setAltura(e.target.value)}/>
